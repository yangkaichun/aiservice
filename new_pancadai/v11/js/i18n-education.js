...
(function () {
  var zh = {
    ...
    fq2_a: "不必。PANCREASaver® 分析的是您既有的腹部 CT 影像——讓同一張影像多一位「AI 助手」閱讀，不需要重複掃描或額外檢查；是否需要安排檢查，請諮詢您的醫師進行評估。",
  ...
  var ja = {
    ...
    fq2_a: "いいえ。PANCREASaver® はお受けになった腹部CT画像を解析します——同じ画像にもう一人の「AIアシスタント」が目を通すだけで、再スキャンや追加検査は不要です。検査の実施については、担当医にご相談ください。",
