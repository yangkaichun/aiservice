...
(function () {
  var zh = {
    ...
    ph_badge: "智慧財產權",
    ph_title_1: "技術壁壘，<span class=\"hl\">來自 10 件發明專利。</span>",
    ph_sub: "台灣 6 件 + 美國 4 件發明專利，採「系統級＋方法級」雙重寫法——醫療 AI 軟體在美國取得專利極為困難，這 4 件美國專利本身就是高競爭門檻。",

    sec_t: "專利列表（10 件）",
    sec_p: "以下為已公告／公開的發明專利證號。專利名稱與請求項細節以官方公告文件為準。",
    us_t: "美國發明專利（4 件）",
    tw_t: "台灣發明專利（6 件）",
    top_t: "保護主題",
    top_p: "每一件專利，都是守護早期胰臟癌偵測的一環：",
    top1: "醫療影像分析系統",
    top1_p: "AI 分析腹部 CT 影像並輸出胰臟病灶偵測結果的系統架構。",
    top2: "機器學習識別胰臟癌方法",
    top2_p: "以機器學習模型識別胰臟癌的方法專利——演算法核心保護。",
    top3: "進階影像分析架構",
    top3_p: "包含特徵萃取、病灶分類與臨床報告整合的進階影像分析架構。",
    us_t: "美國發明專利（4 件）",
    us_p: "這四項美國發明專利，守護著助胰見從「看見」到「判斷」的每一道關鍵環節。第一項專利，保護了 AI 學習辨識胰臟病灶的基礎能力——讓系統能從腹部 CT 影像中，找出醫師肉眼容易遺漏的早期胰臟癌；第二項專利，保護了 AI 的學習與判斷方法——確保在不同醫院、不同設備的影像上，都能維持一致的辨識表現；第三項專利，保護了助胰見的多階段判讀架構——先定位臟器與腫瘤位置，再由多個 AI 模型共同確認病灶，就像多位專家會診，用共識降低誤判風險；第四項專利，保護了雙軌分析架構——不同的分析模組各自判讀後交叉比對，讓每一次判讀都經過多重把關。四項發明層層相扣，構成了助胰見在美國市場最完整的技術護城河。",
    tw_t: "台灣發明專利（6 件）",
    tw_p: "這六項台灣發明專利，從核心技術到新一代架構，完整守護助胰見的每一步演進。前兩項專利，保護了 AI 學習辨識胰臟病灶的核心技術與判斷方法——建立清楚可靠的判斷標準，讓早期胰臟癌的偵測更加穩定可信；接著兩項專利，保護了多模型共識與雙軌交叉驗證的分析架構——多個 AI 模型共同投票、不同模組互相驗證，以集體智慧降低漏看與誤判；最後兩項專利，屬於新一代的進階影像分析技術——讓 AI 能直接從 CT 影像判斷器官是否有疾病、自動標記出最關鍵的影像切片，即使不使用顯影劑也能提供判讀參考，為未來免顯影劑篩檢與更大規模應用奠定基礎。六項專利由核心到前瞻，守護著助胰見在台灣從落地到持續進化的每一個腳步。",

    rel_t: "相關法規",
    rel_p: "本產品另取得台灣 TFDA 醫療器材許可證：衛部醫器製字第007946號。",
    note: "專利證號為公開資訊；實際專利範圍請以各國專利局公告文件為準。",
    back_btn: "回到臨床證據",
  ...
  var en = {
    ...
    top2_p: "Method patents for identifying pancreatic cancer with machine learning — core algorithm protection.",
  ...
  var ja = {
    meta_title: "知的財産ポートフォリオ — 台湾・米国10件の特許 | PANCREASaver® 助胰見®",
    meta_desc: "PANCREASaver®の知的財産：台湾6件・米国4件の発明特許。医療画像分析システム、機械学習による膵臓がん識別方法、高度な画像解析アーキテクチャ。",

    ph_badge: "知的財産",
    ph_title_1: "技術の壁は、<span class=\"hl\">10件の発明特許。</span>",
    ph_sub: "台湾6件＋米国4件の発明特許。「システム＋方法」二重クレーム方式——医療AIソフトウェアの米国特許は極めて難しく、この4件自体が競争障壁です。",

    sec_t: "特許リスト（10件）",
    sec_p: "以下は登録・公開済みの発明特許番号です。特許請求の範囲は各国特許庁の公告文書をご確認ください。",
    us_t: "米国発明特許（4件）",
    tw_t: "台湾発明特許（6件）",
    top_t: "保護テーマ",
    top_p: "特許ファミリーは「システム＋方法」の二重クレームで三大テーマをカバー：",
    top1: "医療画像分析システム",
    top1_p: "腹部CTをAI解析し膵病変検出結果を出力するシステムアーキテクチャ。",
    top2: "機械学習による膵臓がん識別方法",
    top2_p: "機械学習で膵臓がんを識別する方法特許——アルゴリズム中核の保護。",
    top3: "高度な画像解析アーキテクチャ",
    top3_p: "特徴抽出・病変分類・臨床レポート統合を含む高度な画像解析アーキテクチャ。",
    us_t: "米国発明特許（4件）",
    us_p: "この4件の米国発明特許は、助胰見の「見る」から「判断する」までのすべての重要工程を守っています。1件目はAIが膵臓の病変を学習・検出する基本能力を保護——人間の目では見逃しやすい早期膵臓がんをCT画像から見つけ出します。2件目は学習・判断方法を保護——病院や装置が異なっても安定した識別性能を維持します。3件目は多段階の読影アーキテクチャを保護——まず臓器と腫瘍の位置を特定し、複数のAIモデルが共同で病変を確認、専門家会議のように合議で誤判定を減らします。4件目は二重トラックの分析アーキテクチャを保護——異なる分析モジュールが独立に読影し相互検証、すべての読影に多重チェックをかけます。これら4件は米国市場における助胰見の最も完全な技術的堀を形成しています。",
    tw_t: "台湾発明特許（6件）",
    tw_p: "この6件の台湾発明特許は、中核技術から次世代アーキテクチャまで、助胰見の進化の一歩一歩を守っています。最初の2件は膵臓病変検出の中核技術と判断方法を保護——明確で信頼できる判断基準を確立し、早期膵臓がんの検出をより安定・信頼できるものにします。次の2件は複数モデルの合議と二重トラックの相互検証アーキテクチャを保護——複数のAIモデルが投票し、異なるモジュールが相互検証、集団的知性で見落としと誤判定を減らします。最後の2件は次世代の高度画像分析技術——CT画像から臓器の疾患を直接判断し、最も重要なスライスを自動マーク、造影剤なしでも読影参考を提供し、造影剤フリー検診とさらなる応用の基盤を築きます。中核から先端まで、台湾における助胰見の足跡のすべてを守っています。",
    rel_t: "関連規制",
    rel_p: "本製品は台湾TFDA医療機器許可証（衛部醫器製字第007946号）を保有しています。",
    note: "特許番号は公開情報です。実際の権利範囲は各国特許庁の公告文書をご確認ください。",
    back_btn: "臨床エビデンスへ戻る",
    back_href: "clinician.html"
  };
