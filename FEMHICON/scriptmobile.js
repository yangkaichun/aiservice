...
function toggleLibrary(forceState) {
    if (typeof forceState === 'boolean') {
        if (forceState) libraryArea.classList.remove("collapsed");
        else libraryArea.classList.add("collapsed");
    } else {
        libraryArea.classList.toggle("collapsed");
    }
}
